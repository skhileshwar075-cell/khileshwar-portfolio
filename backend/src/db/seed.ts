  ...
  await db.insert(certificatesTable).values([
    {
      ...
      description: "Validated architecture design, cloud migration, and cost optimization strategies for scalable AWS solutions.",
      duration: "40 Hours",
      grade: "Pass",
      skills: ["AWS", "Cloud Architecture", "Security", "Infrastructure"],
      featured: true,
    },
    {
      ...
      issuer: "Scrum.org",
      issueDate: "2022-11",
      credentialId: "PSM-001234",
      credentialUrl: "https://www.scrum.org/certificates",
      description: "Confirmed foundational agile practices, team facilitation, and Scrum mastery for high-performing delivery teams.",
      duration: "16 Hours",
      grade: "A",
    ...
    },
    {
      ...
      description: "Demonstrated ability to deploy, monitor, and maintain solutions on Google Cloud Platform.",
      duration: "5 Weeks",
      grade: "88%",
      skills: ["GCP", "Cloud", "DevOps", "Kubernetes"],
    },
    {
      ...
      description: "Completed an intensive front-end program covering React, responsive UI, and interactive web experiences.",
      duration: "8 Weeks",
      grade: "Grade A",
